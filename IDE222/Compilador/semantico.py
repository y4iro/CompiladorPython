    ...
    #Caso declaracion
        ...
        if(t.tipo=="tipo" and t.contenido=="int"): 
            if(st_lookup(t.hijos[0].contenido) == -1):
                location+=1
                st_insert(t.hijos[0].contenido,t.linea,location,0,"int")
            else:
        ...
        #Caso variable real
            ...
            if(st_lookup(t.hijos[0].contenido) == -1):
                location+=1
                st_insert(t.hijos[0].contenido,t.linea,location,0,"real")
            else:
                typeError(t.hijos[0],"Variable ya declarada")
                t.hijos[0].type="real"
        ...
        #Va pasandole su tipo a sus hermanos
            ...
            if(t.hermano!=None):
                if(st_lookup(t.hermano.contenido) == -1):
                    location+=1
                    if(t.type=="real"):
                        st_insert(t.hermano.contenido,t.linea,location,0.0,t.type)
                    else:
                        st_insert(t.hermano.contenido,t.linea,location,0,t.type)
                else:
